...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recipes_recipe', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=80, blank=True)),
            ('short_description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('serving_size', self.gf('django.db.models.fields.IntegerField')(default=2, db_index=True)),
        ...
        db.send_create_signal(u'recipes', ['Rating'])

        # Adding unique constraint on 'Rating', fields ['recipe', 'rated_by']
        db.create_unique(u'recipes_rating', ['recipe_id', 'rated_by_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Rating', fields ['recipe', 'rated_by']
        db.delete_unique(u'recipes_rating', ['recipe_id', 'rated_by_id'])

        # Deleting model 'Recipe'
        db.delete_table(u'recipes_recipe')

        # Removing M2M table for field tags on 'Recipe'
        db.delete_table(db.shorten_name(u'recipes_recipe_tags'))

        # Deleting model 'RecipeTag'
        db.delete_table(u'recipes_recipetag')

        # Deleting model 'Rating'
        db.delete_table(u'recipes_rating')
